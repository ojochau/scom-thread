...
define("@scom/scom-thread/translations.json.ts", ["require", "exports"], function (require, exports) {
    ...
    exports.default = {
        ...
        "vi": {
            ...
            "post_your_reply": "Đăng phản hồi của bạn...",
            "reply": "Đăng",
            "sign_in_to_reply": "Đăng nhập ngay để phản hồi",
    ...
    let ScomThread = class ScomThread extends components_2.Module {
        ...
        appendReplyInput() {
            ...
            const input = this.$render("i-scom-post-composer", { id: "inputReply", display: 'block', visible: false, padding: { top: '0.75rem', bottom: '0.75rem', left: '1rem', right: '1rem' }, 
                ...
                border: { radius: '.25rem' }, width: '100%', placeholder: this.i18n.get('$post_your_reply'), buttonCaption: this.i18n.get('$reply'), avatar: this._avatar, env: this.env, mediaQueries: [
                    {
                        maxWidth: '767px',
                        properties: {
                            visible: false
